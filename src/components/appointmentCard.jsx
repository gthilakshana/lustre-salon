export default function AppointmentCard({ service, subName, stylist, date, time, payment, cost, due, comingSoon }) {
    return (
        <div className={`relative border border-gray-200  shadow-md p-6 bg-white hover:shadow-lg transition 
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b pb-3 mb-3">
                <h2 className="text-lg font-bold text-gray-800">{service} - <span className="font-medium text-gray-600">{subName}</span></h2>

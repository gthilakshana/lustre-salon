...
export default function AdminServiceUpdate({ isOpen, onClose, service, refresh }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            await axios.put(`${import.meta.env.VITE_API_URL}/api/services/${service._id}`, {
                serviceName,
                subName,
                price,
                description,
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex justify-center items-center px-4">
            <div className="bg-white shadow-2xl relative w-[90%] md:w-[45%] max-h-[80vh] p-6  animate-fadeIn">
                ...
                <h2 className="text-xl font-bold text-gray-800 mb-4">Update Service</h2>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-2 bg-black cursor-pointer text-white rounded-md hover:bg-gray-800 transition disabled:opacity-50"
                    >
